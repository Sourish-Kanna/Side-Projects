...
class Society:
    ...
    def input(self):
        ...
        l2.place(x=40,y=220)
        entry2=Entry(window1,textvar=a)
...
l1=Label(window,text="KALPATARU HILLS HSc",width=20,relief="solid",font=("arial",15,"bold"))
l1.place(x=2,y=5)
...
r1=Radiobutton(window,text="New Entry",variable=rad0,value=1)
r1.place(x=50,y=103)

r1=Radiobutton(window,text="Exit",variable=rad0,value=2)
r1.place(x=50,y=135)

b1=Button(window,text="Next",width=12,bg="brown",fg="white",command=Comp)
b1.place(x=75,y=180)
...
def Window():
    ...
    def Main2():
        ...
        p3="Day of entry: "+str(z[b-1].In_time.strftime("%A"))+" "+str(z[b-1].In_time.strftime("%d"))+"/"+str(z[b-1].In_time.strftime("%m"))+"/"+str(z[b-1].In_time.strftime("%Y"))
        p4="Time of entry: "+str(z[b-1].In_time.strftime("%I"))+":"+str(z[b-1].In_time.strftime("%M"))+" "+str(z[b-1].In_time.strftime("%p"))
    ...
    def Main3():
        ...
        for y in range(b):
            ...
            p3="Day of entry: "+str(z[y].In_time.strftime("%A"))+" "+str(z[y].In_time.strftime("%d"))+"/"+str(z[y].In_time.strftime("%m"))+"/"+str(z[y].In_time.strftime("%Y"))
            p4="Time of entry: "+str(z[y].In_time.strftime("%I"))+":"+str(z[y].In_time.strftime("%M"))+" "+str(z[y].In_time.strftime("%p"))
